...
description: Core maintainability-first review skill for OpenCode. Use when review scope and focus should be inferred from user intent or natural language, with one public skill product.
---
